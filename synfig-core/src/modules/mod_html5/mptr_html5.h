...
#ifndef __SYNFIG_MPTR_HTML5_H
#define __SYNFIG_MPTR_HTML5_H
...
class html5_mptr : public synfig::Importer
{
...
public:
	html5_mptr(const synfig::FileSystem::Identifier &identifier);
	~fhtml5_mptr();
